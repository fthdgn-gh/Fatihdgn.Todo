...
public class FatihdgnTodoAuthClientProvider
{
    ...
    private static Lazy<IFatihdgnTodoAuthClient> _current = new Lazy<IFatihdgnTodoAuthClient>(() => new FatihdgnTodoAuthClient(ProviderConstants.FatihdgnTodoClientBaseUrl, _httpClient));
