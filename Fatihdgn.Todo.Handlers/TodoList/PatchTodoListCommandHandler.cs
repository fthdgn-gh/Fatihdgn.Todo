...
public class PatchTodoListCommandHandler : IRequestHandler<PatchTodoListCommand, OneOf<TodoListDTO, NotFound, Error<ArgumentNullException>>>
{
    private readonly ITodoListRepository _repo;

    public PatchTodoListCommandHandler(ITodoListRepository repo)
    {
        _repo = repo;
    }

    public async Task<OneOf<TodoListDTO, NotFound, Error<ArgumentNullException>>> Handle(PatchTodoListCommand request, CancellationToken cancellationToken)
    {
